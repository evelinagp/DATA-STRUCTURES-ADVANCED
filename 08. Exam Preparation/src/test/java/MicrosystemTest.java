...
public class MicrosystemTest {
    ...
    @Test
    public void removeComputer_should_remove_it_correctly() {
        ...
        Assert.assertEquals(this.microsystem.count(), 2);

        this.microsystem.remove(1);

        Assert.assertEquals(this.microsystem.count(), 1);
    }
    @Test
    public void removeComputerByBrand_should_remove_it_correctly() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void removeComputerByBrand_should_throw_exception() {
